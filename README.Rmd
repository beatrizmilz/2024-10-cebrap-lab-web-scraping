...
- [Raspando informações de páginas HTML estáticos](https://beatrizmilz.github.io/2024-10-cebrap-lab-web-scraping/slides/html-estatico.html)

- [Raspando informações de páginas HTML dinâmicos](https://beatrizmilz.github.io/2024-10-cebrap-lab-web-scraping/slides/html-dinamico.html)
...
```{r}
#| echo: false
tab <- list.files("script-pos-aula/") |>
  tibble::as_tibble() |>
  dplyr::mutate(
    link = glue::glue(
      "[{value}](https://github.com/beatrizmilz/2024-10-cebrap-lab-web-scraping/blob/main/script-pos-aula/{value})"
    )
  ) |>
  dplyr::select(link)
...
- [Exercício para terça-feira](https://github.com/beatrizmilz/2024-10-cebrap-lab-web-scraping/blob/main/exercicios/01-exercicios-terca.R)

- [Exercício para quinta-feira](https://github.com/beatrizmilz/2024-10-cebrap-lab-web-scraping/blob/main/exercicios/02-exercicios-quinta.R)

## Links citados em aula

```{r}
#| echo: false
readr::read_csv2("links.csv") |> 
  dplyr::mutate(Material = glue::glue("[{Material}]({Link})")) |>   dplyr::select(-Link) |> 
  knitr::kable()
```
